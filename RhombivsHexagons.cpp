...
RhombivsHexagons::RhombivsHexagons()
{
}
...
void RhombivsHexagons::FrameStart()
{
...
void RhombivsHexagons::Update(float deltaTimeSeconds)
{
    if(lives >= 0) {
        {
...
void RhombivsHexagons::FrameEnd()
{
}



void RhombivsHexagons::OnInputUpdate(float deltaTime, int mods)
{   

}


void RhombivsHexagons::OnKeyPress(int key, int mods)
{   
}


void RhombivsHexagons::OnKeyRelease(int key, int mods)
{
}


void RhombivsHexagons::OnMouseMove(int mouseX, int mouseY, int deltaX, int deltaY)
{
    for(int i = 0; i < rhombi; i++) { 
        if(rhPush[i]) {
...
void RhombivsHexagons::OnMouseBtnPress(int mouseX, int mouseY, int button, int mods)
{
...
void RhombivsHexagons::OnMouseBtnRelease(int mouseX, int mouseY, int button, int mods)
{
    if(IS_BIT_SET(button, GLFW_MOUSE_BUTTON_LEFT)) {
        for(int i = 0; i < rhombi; i++) {
            for(int j = 0; j < 9; j++) {
...
void RhombivsHexagons::OnMouseScroll(int mouseX, int mouseY, int offsetX, int offsetY)
{
}


void RhombivsHexagons::OnWindowResize(int width, int height)
{
}
